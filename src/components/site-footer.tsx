...
import { MapPin, Phone, Mail, MessageCircle, GraduationCap, Truck, Briefcase, BarChart3, Map } from "lucide-react";
      ...
      <div className="mx-auto max-w-7xl px-6 py-14 grid md:grid-cols-4 gap-10">
        ...
        <div className="md:col-span-1">
          ...
          <p className="mt-2 text-sm text-muted-foreground leading-relaxed max-w-xs">
            Be EcoWise — Empowering Rwandan farmers and supplying quality food and beverages across all Districts.
          </p>
          <a
            href={WHATSAPP_LINK}
            target="_blank"
        ...
        <div className="text-sm">
          <div className="font-semibold text-foreground mb-4 uppercase tracking-wider text-xs text-muted-foreground">Platform</div>
          <ul className="space-y-3 text-muted-foreground">
            <li>
              <Link to="/browse" className="flex items-center gap-2 hover:text-foreground transition-colors">
                <Truck className="w-3.5 h-3.5 text-leaf shrink-0" /> Shop Products
              </Link>
            </li>
            <li>
              <Link to="/map" className="flex items-center gap-2 hover:text-foreground transition-colors">
                <Map className="w-3.5 h-3.5 text-leaf shrink-0" /> Market Map
              </Link>
            </li>
            <li>
              <Link to="/training" className="flex items-center gap-2 hover:text-foreground transition-colors">
                <GraduationCap className="w-3.5 h-3.5 text-leaf shrink-0" /> Farmer Academy
              </Link>
            </li>
            <li>
              <Link to="/consultancy" className="flex items-center gap-2 hover:text-foreground transition-colors">
                <Briefcase className="w-3.5 h-3.5 text-leaf shrink-0" /> Consultancy
              </Link>
            </li>
            <li>
              <Link to="/tracking" className="flex items-center gap-2 hover:text-foreground transition-colors">
                <Truck className="w-3.5 h-3.5 text-leaf shrink-0" /> Track Delivery
              </Link>
            </li>
            <li>
              <Link to="/impact" className="flex items-center gap-2 hover:text-foreground transition-colors">
        ...
        {/* Company Links */}
        <div className="text-sm">
          <div className="font-semibold text-foreground mb-4 uppercase tracking-wider text-xs text-muted-foreground">Company</div>
          <ul className="space-y-3 text-muted-foreground">
            <li><a href="/#about" className="hover:text-foreground transition-colors">About Deacomart</a></li>
            ...
            <li>
              <Link to="/dashboard" className="hover:text-foreground transition-colors">Inventory Dashboard</Link>
            </li>
          </ul>
        </div>
        ...
        {/* Contact */}
        <div className="text-sm">
          <div className="font-semibold text-foreground mb-4 uppercase tracking-wider text-xs text-muted-foreground">Contact</div>
          <ul className="space-y-3 text-muted-foreground">
            <li className="flex items-start gap-2">
              <MapPin className="w-4 h-4 text-leaf mt-0.5 shrink-0" />
              <span>Kigali, Rwanda<br />(All Districts served)</span>
            </li>
          ...
          <div className="mt-5 p-3 bg-secondary/50 rounded-xl text-xs text-muted-foreground space-y-1">
            <div><span className="font-semibold text-foreground">TIN:</span> 150039210</div>
            <div><span className="font-semibold text-foreground">Bank:</span> Equity Bank · 4014201311299</div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-7xl px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground">
          ...
          <span className="flex items-center gap-4">
            ...
            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="hover:text-foreground">{WHATSAPP_NUMBER}</a>
          </span>
        </div>
      </div>
    </footer>
